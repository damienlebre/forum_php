...
<h1 class="text-center">Bienvenue sur votre profil <?=$_SESSION['user']?></h1>
...
<div class="card" style="width: 18rem;">
  ...
  <div class="card-body">
    <h5 class="card-title"><?=$_SESSION['user']?></h5>
...
<form method="post">
        ...
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Ajouter une présentation</label>
